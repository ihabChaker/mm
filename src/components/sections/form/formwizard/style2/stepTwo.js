            ...
            <li>
              <div className="ms-radio-img">
                ...
                <div className="ms-payment-img">
                  <img src={process.env.PUBLIC_URL + '/assets/img/payment/payment-payoneer.png'} alt="payment" />
                </div>
              </div>
            </li>
            <li>
              <div className="ms-radio-img">
                <input type="radio" name="payment-method" defaultValue />
                <div className="ms-payment-img">
                  <img src={process.env.PUBLIC_URL + '/assets/img/payment/payment-visa.png'} alt="payment" />
                </div>
              </div>
            </li>
            <li>
              <div className="ms-radio-img">
                <input type="radio" name="payment-method" defaultValue />
                <div className="ms-payment-img">
                  <img src={process.env.PUBLIC_URL + '/assets/img/payment/payment-paypal.png'} alt="payment" />
                </div>
              </div>
            </li>
            <li>
              <div className="ms-radio-img">
                <input type="radio" name="payment-method" defaultValue />
                <div className="ms-payment-img">
                  <img src={process.env.PUBLIC_URL + '/assets/img/payment/payment-master.png'} alt="payment" />
                </div>
              </div>
            </li>
          </ul>
