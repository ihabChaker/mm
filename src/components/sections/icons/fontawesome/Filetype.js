                ...
                <div className="ms-panel">
                    ...
                    <div className="ms-panel-body">
                        <div className="ms-icons-list row">
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="far fa-file-movie" /> fa-file-movie <span className="text-muted">(alias)</span> </div>
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="far fa-file-pdf" /> fa-file-pdf</div>
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="far fa-file-photo" /> fa-file-photo <span className="text-muted">(alias)</span> </div>
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="far fa-file-picture" /> fa-file-picture <span className="text-muted">(alias)</span> </div>
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="far fa-file-powerpoint" /> fa-file-powerpoint</div>
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="far fa-file-sound" /> fa-file-sound <span className="text-muted">(alias)</span> </div>
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="far fa-file-zip" /> fa-file-zip <span className="text-muted">(alias)</span> </div>
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-3"><i className="far fa-send" /> fa-send <span className="text-muted">(alias)</span> </div>
