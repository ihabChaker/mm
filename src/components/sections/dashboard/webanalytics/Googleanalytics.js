        ...
        return (
            <div className="ms-panel ms-device-sessions">
                ...
                <div className="ms-panel-body">
                    <div className="row">
                        <div className="col-xl-4 col-md-4 col-sm-4 col-4 ms-device">
                            <i className="material-icons bg-primary">desktop_windows</i>
                            <h4>Desktop</h4>
                            <p className="ms-text-primary">45.07%</p>
                            <p className="ms-text-primary">201,434</p>
                        </div>
                        <div className="col-xl-4 col-md-4 col-sm-4 col-4 ms-device">
                            <i className="material-icons bg-danger">tablet_mac</i>
                            <h4>Tablet</h4>
                            <p className="ms-text-danger">29.05%</p>
                            <p className="ms-text-danger">134,693</p>
                        </div>
                        <div className="col-xl-4 col-md-4 col-sm-4 col-4 ms-device">
                            <i className="material-icons bg-warning">phone_iphone</i>
                            <h4>Mobile</h4>
