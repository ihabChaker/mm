...
export const data = [
    {
        id: 1,
        img: "assets/img/employee-list/employee-(1).jpg",
        name: "Denise",
    ...
    {
        id: 2,
        img: "assets/img/employee-list/employee-(3).jpg",
        name: "Jennifer",
    ...
    {
        id: 3,
        img: "assets/img/employee-list/employee-(5).jpg",
        name: "Kyle",
    ...
    {
        id: 4,
        img: "assets/img/employee-list/employee-(4).jpg",
        name: "Joshua",
    ...
    {
        id: 5,
        img: "assets/img/employee-list/employee-(2).jpg",
        name: "Adwerd",
    ...
    {
        id: 6,
        img: "assets/img/employee-list/employee-(6).jpg",
        name: "Daniel",
    ...
    {
        id: 7,
        img: "assets/img/employee-list/employee-(7).jpg",
        name: "Jennifer",
        email: "jennifer@example.com",
    ...
    {
        id: 8,
        img: "assets/img/employee-list/employee-(8).jpg",
        name: "Kyle",
        email: "kyle698@example.com",
        address: "Los Angeles",
        mobile: "(836) 257 1312",
